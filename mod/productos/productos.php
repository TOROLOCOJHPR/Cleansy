<?php
    ...
    $sala = array(
        ...
        ['producto'=>'Limpia pisos',"src"=>"/img/productos/limpia-pisos-2.jpg"],
        ['producto'=>'Limpia cristal',"src"=>"/img/productos/limpia-cristal.jpg"],
        ['producto'=>'Limpiador desinfectante',"src"=>"/img/productos/liquido-desinfectante.jpg"],
        ['producto'=>'Escoba',"src"=>"/img/productos/escoba-6.jpg"],
    ...
    $cocina = array(
        ...
        ['producto'=>'Higiénicos',"src"=>"/img/productos/higienicos-cocina.jpg"],
        ['producto'=>'Trapeadores antibacteriales',"src"=>"/img/productos/trapeador-antibacterial.jpg"],
        ['producto'=>'Jaboneras',"src"=>"/img/productos/jaboneras.jpg"]
    );
    $comedor = array(
        ['producto'=>'Abrillantador de muebles',"src"=>"/img/productos/abrillantador-de-muebles.jpg"],
        ['producto'=>'Escoba',"src"=>"/img/productos/escoba.jpg"],
        ['producto'=>'Trapeador',"src"=>"/img/productos/trapeador-2.jpg"],
    ...
    $recamara = array(
        ['producto'=>'escoba',"src"=>"/img/productos/escoba-5.jpg"],
        ['producto'=>'Abrillantador de muebles',"src"=>"/img/productos/abrillantador-de-muebles.jpg"],
        ['producto'=>'Trapeador',"src"=>"/img/productos/trapeador-6.jpg"],
        ['producto'=>'Franela',"src"=>"/img/productos/franela.jpg"],
        ['producto'=>'Limpiador de pisos',"src"=>"/img/productos/limpia-pisos.jpg"],
        ['producto'=>'Liquido desinfectante',"src"=>"/img/productos/liquido-desinfectante.jpg"],
        ['producto'=>'Bolsas',"src"=>"/img/productos/bolsas.jpg"],
        ...
        ['producto'=>'Recogedor',"src"=>"/img/productos/recogedor-2.jpg"]
    );
    $baño = array(
        ...
        ['producto'=>'Shampoo líquido para manos',"src"=>"/img/productos/shampoo-liquido-para-manos-2.jpg"],
        ['producto'=>'Limpia cristal',"src"=>"/img/productos/limpia-cristal.jpg"],
    ...
    $pisos = array(
        ...
        ['producto'=>'escoba',"src"=>"/img/productos/escoba-4.jpg"],
        ['producto'=>'Trapeador',"src"=>"/img/productos/trapeador-4.jpg"],
        ['producto'=>'Desinfectantes',"src"=>"/img/productos/liquido-desinfectante.jpg"],
        ['producto'=>'Recogedor',"src"=>"/img/productos/recogedor.jpg"]
    );
    $muebles = array(
        ['producto'=>'Abrillantador de muebles',"src"=>"/img/productos/abrillantador-de-muebles.jpg"],
        ['producto'=>'Plumero',"src"=>"/img/productos/plumero.jpg"],
        ['producto'=>'Desinfectante',"src"=>"/img/productos/liquido-desinfectante.jpg"],
        ['producto'=>'Franela',"src"=>"/img/productos/franela.jpg"]
    );
    $auto = array(
        ...
        ['producto'=>'Aromas Ambientales',"src"=>"/img/productos/aromatizante-ambiental-2.jpg"],
        ['producto'=>'Guante para carro',"src"=>"/img/productos/guante-para-carro.jpg"],
        ['producto'=>'Esponjas',"src"=>"/img/productos/esponjas.jpg"],
    );
    $exteriores = array(
        ['producto'=>'EScobas',"src"=>"/img/productos/escoba-2.jpg"],
        ['producto'=>'Recogedores',"src"=>"/img/productos/recogedor.jpg"],
        ['producto'=>'Trapeadores',"src"=>"/img/productos/trapeador-3.jpg"],
        ...
        ['producto'=>'Limpia pisos',"src"=>"/img/productos/limpia-pisos-2.jpg"],
        ['producto'=>'Bolsas',"src"=>"/img/productos/bolsas.jpg"],
        ['producto'=>'Cestos',"src"=>"/img/productos/cestos-2.jpg"],
    );
    $lavado = array(
        ['producto'=>'Detergente',"src"=>"/img/productos/detergente.jpg"],
        ['producto'=>'Detergente de ropa',"src"=>"/img/productos/detergente-para-ropa.jpg"],
        ...
        ['producto'=>'Escobas',"src"=>"/img/productos/escoba-3.jpg"],
        ['producto'=>'Trapeadores',"src"=>"/img/productos/trapeador-5.jpg"],
        ...
        ['producto'=>'Recogedores',"src"=>"/img/productos/recogedor-2.jpg"],
    );
...
?>
    <h2 class="text-center py-3 mt-5 mt-md-0 ff-Century text-uppercase">
        <?php echo $categoria?>
    </h2>
...
<?php
    if($productos == ""){
?>
    <div class="mh-70 d-flex justify-content-center align-items-center text-center text-dark">
        <h2 class="px-3">No se encontraron productos intenta de nuevo</h2>
    </div>
<?php
    }else{
        foreach($productos as $row){
?>
        <div class="col-sm-6 col-lg-4 col-xl-3 my-3 mh-90" style="height:300px; width:100%;">
            <!-- tarjeta -->
            <div class=" tarjeta-producto border rounded d-flex flex-column mx-auto">
                ...
                <!-- nombre del producto -->
                <div class="flex-grow-1 w-100 border-top d-flex align-items-center justify-content-center text-center">
                    <div>
