<header class="fixed-top fs-1-2 ff-Century">
    <nav class="navbar navbar-expand-md navbar-light py-3 py-sm-2 py-md-1 h-100">
        ...
        <div class="w-25 h-100 text-center d-none d-md-flex c-align-middle"><a class="h-100" href="/"><img class="h-100" style="" src="/img/Logo.png"/></a></div>
        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <!-- nuestra empresa -->
            <li class="nav-item">
                <a class="nav-link" href="/nuestraEmpresa">NUESTRA EMPRESA</a>
            </li>
            <!-- productos -->
            <li class="nav-item">
