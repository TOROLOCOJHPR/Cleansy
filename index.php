...
?>
    <body>
        ...
        <div class="slider w-100 position-relative text-white ff-Luna t-shadow-2-black" style="overflow:hidden;">
            <!-- slide -->
            <div id="sliderPrincipal" class="w-100 h-100 d-flex flex-column flex-wrap">
                <!-- contenedor uno -->
                <div class="w-100 h-100">
                    <div class="imgSlider bg-cover-center w-100 h-100 position-absolute" style="background-image:url('/img/Home1.jpg');"></div>
                    <div class=" item w-100 position-absolute text-right px-2 px-md-4">
                        <span>Todo lo que necesites</span><br>
                        <span>y un Poco más</span>
                    </div>
                </div>
                <!-- contenedor dos -->
                <div class="w-100 h-100 bg-secondary">
                    <div class="imgSlider bg-cover-center w-100 h-100 position-absolute" style="background-image:url('/img/Home2.jpg');"></div>
                    <div class=" item w-100 position-absolute text-right px-2 px-md-4">
        ...
        <div class="w-100 position-relative text-center">
            ...
            <div class="row mx-0">
                <div class="col-12 col-sm-8 col-md-4 mx-auto p-3">
                    <a class="w-25 d-block text-dark mx-auto mx-md-0 ml-md-auto" href="/productos/#hogar">
                ...
                <div class="col-12 col-sm-8 col-md-4 p-3 mx-auto">
                    <a class="w-25 d-block text-dark mx-auto" href="/productos/#oficina">
                ...
                <div class="col-12 col-sm-8 col-md-4 p-3 mx-auto">
                    <a class="w-25 d-block text-dark mx-auto mx-md-0 mr-md-auto" href="/productos/#auto">
